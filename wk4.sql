...
SELECT [Year], [Factory Name], [Product Description], [Total Units produced], [Total Units rejected], Qty_Rank
 FROM (
SELECT RIGHT(MANUFACTURE_YEARMONTH,6) AS 'Year', FACTORY_LABEL AS 'Factory Name', PRODUCT_DESCRIPTION AS 'Product Description', 
SUM(QTY_PASSED) AS 'Total Units produced', SUM(QTY_FAILED) AS 'Total Units rejected', 
